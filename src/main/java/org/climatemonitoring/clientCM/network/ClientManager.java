package org.climatemonitoring.clientCM.network;
...
public class ClientManager {
    ...
    public int insertSurvey(Survey survey){
        try{
            return rmiService.insertSurvey(survey);
        }catch (RemoteException e){
    ...
    public SurveysAggregate getSurveysAggregate(int poi_id){
        try{
            return rmiService.getSurveysAggregate(poi_id);
        }catch (RemoteException e){
