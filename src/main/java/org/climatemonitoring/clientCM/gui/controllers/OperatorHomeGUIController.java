...
import org.climatemonitoring.clientCM.gui.views.OperatorHomeGUI;
...
public class OperatorHomeGUIController {
    ...
    public OperatorHomeGUIController(OperatorHomeGUI view, User user) {
        ...
        view.getGreetingLabel().setText("Benvenuto " + user.getUserid() + " del centro " + user.getCenterid() + " inserisci i dati dell'area geografica di cui vuoi visualizzare le rilevazioni :");
            ...
            public void actionPerformed(ActionEvent e) {
                try{
                    ...
                    if (selectedRow != -1) {
                        ...
                        int surveyId = getClientManager().insertSurvey(survey);
                        if(surveyId > 0){
