package org.climatemonitoring.serverCM.database;
...
public class PredefinedQuery {
    ...
    //SELECT QUERIES
    public  enum Select{USER, USER_LOGIN_INFO, USER_EXISTS, USER_EMAIL_EXISTS, CLIMATECENTER, CLIMATECENTER_BY_ID, CLIMATECENTER_BY_ATTRIBUTES, POI, POI_BY_DATA, POI_BY_NAME, POI_BY_COORDINATES, SURVEY_BY_ID, POIS_BY_CENTER, CENTERS_FOR_POI, SURVEYS, POI_SURVEYS_AGGREGATE, USERS_FOR_CENTER,DATABASE,TABLE_FROM_DATABASE}
    public static final Hashtable<Select, String> select_queries = new Hashtable<>(){
...

        {
            ...
            //Put Select POI SURVEYS AGGREGATE
            put(
    ...
    public static final Hashtable<Update, String> update_queries = new Hashtable<>(){
    ...
    public static final Hashtable<Delete, String> delete_queries = new Hashtable<>(){
