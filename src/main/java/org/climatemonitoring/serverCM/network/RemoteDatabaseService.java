package org.climatemonitoring.serverCM.network;

import org.apache.commons.dbcp2.BasicDataSource;
import org.climatemonitoring.serverCM.database.DbManager;
import org.climatemonitoring.serverCM.database.PredefinedQuery;
...
public class RemoteDatabaseService extends UnicastRemoteObject implements RemoteDatabaseServiceInterface {
    ...
    @Override
    public int insertSurvey(Survey survey) throws RemoteException {
        BasicDataSource dataSource = DbManager.getDataSource();
    ...
    @Override
    public SurveysAggregate getSurveysAggregate(int poi_id) throws RemoteException {
